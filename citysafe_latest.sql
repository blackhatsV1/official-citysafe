-- CitySafe Database Reconstruction Script
-- Generated to restore dropped tables in XAMPP
...
CREATE TABLE `disaster_reports` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `fk_responder` (`responder_id`),
  CONSTRAINT `disaster_reports_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_responder` FOREIGN KEY (`responder_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(20, 20, 'Landslide', '2025-08-21 15:05:11', 'Alviola Street, Tejero, Cebu City, Central Visayas, 6666, Philippines', 'pending', NULL, NULL, NULL);
...
CREATE TABLE `risk_assessments` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `risk_assessments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `responders` (
  ...
  CONSTRAINT `responders_ibfk_1` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `deploys` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `deploys_ibfk_1` FOREIGN KEY (`responder_id`) REFERENCES `responders` (`id`) ON DELETE SET NULL,
  CONSTRAINT `deploys_ibfk_2` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`) ON DELETE SET NULL,
  CONSTRAINT `deploys_ibfk_3` FOREIGN KEY (`incident_id`) REFERENCES `disaster_reports` (`id`) ON DELETE SET NULL,
  CONSTRAINT `deploys_ibfk_4` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
